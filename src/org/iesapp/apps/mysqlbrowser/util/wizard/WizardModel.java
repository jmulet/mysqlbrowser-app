...
public class WizardModel {
    ...
    protected final HashMap titleStepMap;
     ...
     */    
     ...
     /**
      * Register panel with title support
      * @param id
      * @param title
      * @param descriptor 
      */
    public void registerPanel(Object id, String title, WizardPanelDescriptor descriptor) {
    ...
    public HashMap getTitleStepMap() {
        return titleStepMap;
    }
    
    public Object getPanelwithIdDescriptor(String id)
    {
        return ((WizardPanelDescriptor) this.panelHashmap.get(id)).getPanelComponent();
    }
